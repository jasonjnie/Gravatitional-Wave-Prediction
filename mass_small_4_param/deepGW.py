...
def get_a_batch(inputs, labels, batch_size, num_gpus, step):
    ...
    label_batch = np.zeros([batch_size, num_gpus, 4])
...
def read_dataset(phase):
    ...
    if phase == 'train':
        ...
        #ftrain = h5py.File('/Users/lanrui/git/dataset/ProperWhitenGW/TrainEOB_q-1-10-0.02_ProperWhitenZ.h5', 'r')
        ...
        #ftest = h5py.File('/Users/lanrui/git/dataset/ProperWhitenGW/TestEOB_q-1-10-0.02_ProperWhitenZ.h5', 'r')
        ...
        #fval = h5py.File('/Users/lanrui/git/dataset/ProperWhitenGW/ValEOB_q-1-10-0.02_ProperWhitenZ.h5', 'r')
...
def computer_batch_snr(snr, num_epoch, epoch):
    return 20 - ((20 - snr) * (epoch / num_epoch))
...
def inference_mass_estimator_4conv(inputs):
    ...
    with tf.name_scope('Relu_layer7'):
        w_linear3 = weight_variable('w_linear3', [64, 4])
        b_linear3 = bias_variable('b_linear3', [4])
